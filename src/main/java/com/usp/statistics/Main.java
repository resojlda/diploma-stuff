 ...
 */
public class Main {
    public static void main(String[] args) throws InterruptedException, NoSuchMethodException, IllegalAccessException, InvocationTargetException, VkException {
...
//        data.print(result);
    ...
    public static void execute() throws InterruptedException, NoSuchMethodException, InvocationTargetException, IllegalAccessException, VkException {
        HttpVkApi api = new HttpVkApi("5301779", "ofLUbv8BcQbLAPgBaGG3", "https://oauth.vk.com/blank.html");
        VkDataAnalytics st = new VkCareerStatistics(api);
        HashMap<String, Integer> hashMap = st.employedStats(5439, new VkOAuthToken("aa26341e03ccbf4709deab1c0e2f912987fc96b7d962cb12d2f559ce3e48e3df5a25da4edd1da7de6ef74", 86400, 50306394));
        st.print(hashMap);
